...
function SettingsScreen() {
  ...
  useEffect(() => {
    const setInitialDataFromStorage = async () => {
      ...
      const autoWaterIntakeEnabled = (await AsyncStorage.getItem('autoWaterIntakeEnabled')) || null;
  ...
  const toggleSwitch = async () => {
    try {
      dispatch(setSuggestedWaterAmount(0));
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.settingField}>
        ...
        <TouchableOpacity style={styles.settingTitle} onPress={() => navigation.navigate('Weight')}>
          {data.weight && <Text style={{ fontWeight: 100, fontSize: 20 }}>{data.weight} kg</Text>}
          {!data.weight && <Text style={{ fontWeight: 100, fontSize: 20 }}>-- kg</Text>}
          <Entypo name='chevron-small-right' size={24} color='#525252' />
        </TouchableOpacity>
      </View>
      <View style={styles.settingField}>
        <View style={styles.settingTitle}>
          <MaterialCommunityIcons name='human-male-height-variant' size={24} color='#525252' />
          <Text style={{ fontWeight: 400, fontSize: 22 }}>Height</Text>
        </View>
        <TouchableOpacity style={styles.settingTitle} onPress={() => navigation.navigate('Height')}>
          {data.height && <Text style={{ fontWeight: 100, fontSize: 20 }}>{data.height} cm</Text>}
          {!data.height && <Text style={{ fontWeight: 100, fontSize: 20 }}>-- cm</Text>}
          <Entypo name='chevron-small-right' size={24} color='#525252' />
        </TouchableOpacity>
      </View>
      <View style={styles.settingField}>
        <View style={styles.settingTitle}>
          <MaterialCommunityIcons name='calendar-account' size={24} color='#525252' />
          <Text style={{ fontWeight: 400, fontSize: 22 }}>Age</Text>
        </View>
        <TouchableOpacity style={styles.settingTitle} onPress={() => navigation.navigate('Age')}>
          {data.age && <Text style={{ fontWeight: 100, fontSize: 20 }}>{data.age}</Text>}
          {!data.age && <Text style={{ fontWeight: 100, fontSize: 20 }}>--</Text>}
          <Entypo name='chevron-small-right' size={24} color='#525252' />
        </TouchableOpacity>
      </View>
      <View style={styles.settingField}>
        ...
        <TouchableOpacity style={styles.settingTitle} onPress={() => navigation.navigate('Gender')}>
          {data.gender && <Text style={{ fontWeight: 100, fontSize: 20 }}>{data.gender}</Text>}
          {!data.gender && <Text style={{ fontWeight: 100, fontSize: 20 }}>--</Text>}
          <Entypo name='chevron-small-right' size={24} color='#525252' />
        </TouchableOpacity>
      </View>
      <View style={styles.settingField}>
        <View style={styles.settingTitle}>
          ...
          <Text style={{ fontWeight: 400, fontSize: 22 }}>Calculate water intake</Text>
        </View>
        <Switch value={!!data.autoWaterIntakeEnabled} onValueChange={toggleSwitch} />
      </View>
