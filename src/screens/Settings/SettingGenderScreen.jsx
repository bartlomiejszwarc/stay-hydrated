  ...
  return (
    <SafeAreaView style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate('Settings')}>
        <Entypo name='chevron-small-left' size={42} color='black' style={{ paddingLeft: 10 }} />
      </TouchableOpacity>
      <View style={styles.settingField}>
        ...
        <TouchableOpacity style={styles.settingTitle}>
          <View style={styles.genderButtonsContainer}>
            <TouchableOpacity
              style={store.gender === 'Male' ? styles.genderOptionButtonActive : styles.genderOptionButtonInactive}
              onPress={() => {
            ...
            <TouchableOpacity
              style={store.gender === 'Female' ? styles.genderOptionButtonActive : styles.genderOptionButtonInactive}
              onPress={() => {
